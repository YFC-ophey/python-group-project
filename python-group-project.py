...
#2. Define functions to allow the user to log in using a PW which satisfy the ff: Rules:

#2. Should Contain atleast one upper case letter
    ...
    while attempt < 3:
        ...
        if attempts > 0:
            ...
            if attempts > 0:
                ...
                attempts = check_password_lower(pword)
                if attempts > 0:
                    attempt = attempt + attempts
                else:
...
def create_password():
    ...
    print("Once the password meets all requirements, you will gain access.")
...
#6. 6-	The system must calculate the GPA of each student based on the grades that were entered in the previous step according to the following function:
...
def calc_gpa(student_grades,credit_hours):
    ...
    for i in student_grades:
        ...
        for j in i:
            ...
            gpa1 = round((gpa1 + gpa2),2)
            count += 1
        gpas.append(gpa1)
    return(gpas)
#7.  7-	The system must assign students to schools based on the following matrix:
#School of Engineering: 90 >= GPA <=100
#School of Business: 80>= GPA <90
#Law School: 70 >= GPA <80
#Not accepted: GPA <70

#8. 8-	The system must be able to print the following:
...
def accepted_students(schools):
    ...
    #printing schools and its number of students
    for i in schools:
        if i[0] == "Not Accepted":
            pass
        else:
            print(i[0],":",len(i)-1)
    #printing number of not accepted students
    for i in schools:
        if i[0] != "Not Accepted":
            pass
        else:
...
#if the returned value of check_password is an int then will print the number of tries exceed and will exit the program    
